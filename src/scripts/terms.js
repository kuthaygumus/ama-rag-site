...
export const terms = {
  ...
  cosine: { title: 'Cosine benzerliği', body: 'İki vektörün aynı yöne ne kadar baktığı. 1 = aynı yön (aynı anlam), 0 = ilgisiz.' },
  topk: { title: 'Top-k', body: 'Aramanın döndürdüğü en yakın k parça. k küçükse cevap kaçabilir, büyükse prompt gürültüyle dolar.' },
  ...
  context: { title: 'Context window', body: 'Modelin tek seferde okuyabileceği token sınırı. Prompt, kaynaklar ve cevap bu sınıra sığmak zorunda.' },
  ...
  finetune: { title: 'Fine-tuning', body: 'Hazır bir modeli kendi örneklerinizle biraz daha eğitmek. Bilgiyi ağırlıklara yazar; değiştirmek yeniden eğitim ister.' },
  ...
  mrr: { title: 'MRR', body: 'Doğru sonucun kaçıncı sırada geldiğinin ortalaması (1/sıra). 1,0 = doğru sonuç hep ilk sırada.' },
  ...
  pii: { title: 'Kişisel veri (PII)', body: 'Bir kişiyi tanımlayan bilgi: ad, sicil numarası, telefon, e-posta. Doküman sisteme girerken, vektöre çevrilmeden önce maskelenir.' },
